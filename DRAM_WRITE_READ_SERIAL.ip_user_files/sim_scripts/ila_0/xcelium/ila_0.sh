...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../DRAM_WRITE_READ_SERIAL.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../DRAM_WRITE_READ_SERIAL.gen/sources_1/ip/ila_0/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/heigke/Dokument/TAIF_ADVANIA/DRAM_research/DRAM_WRITE_READ_SERIAL/DRAM_WRITE_READ_SERIAL.cache/compile_simlib/xcelium"
  fi
