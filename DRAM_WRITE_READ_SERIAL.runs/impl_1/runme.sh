...
HD_PWD='/home/heigke/Dokument/TAIF_ADVANIA/DRAM_research/DRAM_WRITE_READ_SERIAL/DRAM_WRITE_READ_SERIAL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dram_simple.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dram_simple.tcl -notrace
