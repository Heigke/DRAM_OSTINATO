...
HD_PWD='/home/heigke/Dokument/TAIF_ADVANIA/DRAM_research/DRAM_WRITE_READ_SERIAL/DRAM_WRITE_READ_SERIAL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dram_simple.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dram_simple.tcl
