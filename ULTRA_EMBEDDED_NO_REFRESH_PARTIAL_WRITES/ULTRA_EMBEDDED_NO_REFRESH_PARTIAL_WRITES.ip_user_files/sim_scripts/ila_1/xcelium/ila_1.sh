...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../ULTRA_EMBEDDED_NO_REFRESH_PARTIAL_WRITES.gen/sources_1/ip/ila_1/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../ULTRA_EMBEDDED_NO_REFRESH_PARTIAL_WRITES.gen/sources_1/ip/ila_1/hdl/verilog" \
