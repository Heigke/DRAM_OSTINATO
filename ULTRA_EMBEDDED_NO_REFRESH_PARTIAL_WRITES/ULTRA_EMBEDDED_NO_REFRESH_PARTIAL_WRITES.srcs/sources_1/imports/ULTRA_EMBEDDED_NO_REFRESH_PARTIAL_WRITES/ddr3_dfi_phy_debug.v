...
(* mark_debug = "true" *) wire        ila_phy_wrdata_en = dfi_wrdata_en_i;
(* mark_debug = "true" *) wire [31:0] ila_phy_wrdata = dfi_wrdata_i;
(* mark_debug = "true" *) wire [3:0]  ila_phy_wrdata_mask = dfi_wrdata_mask_i;
(* mark_debug = "true" *) wire        ila_phy_wr_valid_q0 = wr_valid_q0;
(* mark_debug = "true" *) wire        ila_phy_wr_valid_q1 = wr_valid_q1;
(* mark_debug = "true" *) wire        ila_phy_dqs_out_en_n = dqs_out_en_n_q;
(* mark_debug = "true" *) wire [3:0]  ila_phy_dfi_wr_mask_q = dfi_wr_mask_q;
(* mark_debug = "true" *) wire [1:0]  ila_phy_dm_out = dm_out_w;
reg cfg_valid_q;
