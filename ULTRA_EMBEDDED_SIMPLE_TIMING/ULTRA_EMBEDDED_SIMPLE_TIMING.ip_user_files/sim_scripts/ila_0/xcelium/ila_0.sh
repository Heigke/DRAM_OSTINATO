...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../ULTRA_EMBEDDED_SIMPLE_TIMING.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../ULTRA_EMBEDDED_SIMPLE_TIMING.gen/sources_1/ip/ila_0/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/heigke/Dokument/TAIF_ADVANIA/DRAM_research/DRAM_WRITE_READ_SERIAL/ULTRA_EMBEDDED_SIMPLE_TIMING/ULTRA_EMBEDDED_SIMPLE_TIMING.cache/compile_simlib/xcelium"
  fi
