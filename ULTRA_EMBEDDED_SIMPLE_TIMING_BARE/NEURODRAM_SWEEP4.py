...
DECAY_TIMES = [0, 5, 10, 30, 60, 120, 300]  # Up to 5 minutes
...
class NeuroCharacterizer:
    ...
    def phase1_full_decay_analysis(self):
        ...
        # Configure for full charge writes
        ...
        for pattern_info in TEST_PATTERNS:
            ...
            for decay_time in DECAY_TIMES:
                ...
                for addr in test_addresses:
                    for _ in range(5):  # Multiple writes for reliability
                ...
                for i, addr in enumerate(test_addresses):
                    ...
                    self.progress_bar(i + 1, len(test_addresses), 
                ...
                if decay_results:
                    ...
                    print(f"  Cells <50% retention: {cells_failed}/{len(decay_results)}{Style.RESET_ALL}")
