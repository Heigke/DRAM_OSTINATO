...
HD_PWD='/home/heigke/Dokument/TAIF_ADVANIA/DRAM_research/DRAM_WRITE_READ_SERIAL/ULTRA_EMBEDDED_SIMPLE_TIMING_BARE/ULTRA_EMBEDDED_SIMPLE_TIMING_BARE.runs/impl_1'
cd "$HD_PWD"
