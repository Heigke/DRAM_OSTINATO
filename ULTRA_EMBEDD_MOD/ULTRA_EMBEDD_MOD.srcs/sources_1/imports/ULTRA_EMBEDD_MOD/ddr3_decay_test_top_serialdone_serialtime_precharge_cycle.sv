...
always_ff @(posedge clk_phy_sys or posedge sys_rst_fsm_phy) begin
    if (sys_rst_fsm_phy) begin
        pattern_select_q <= 3'd0;
    end else if (current_state_q == S_DONE && next_state_s == S_IDLE) begin
        pattern_select_q <= pattern_select_q + 1;
    end
end
// ...your state register always_ff
// ...your pattern_select_q always_ff

// Now add this:
always_comb begin
    case (pattern_select_q)
        3'd0: data_to_write_q = 32'hDEADBEEF;
        3'd1: data_to_write_q = 32'h1234ABCD;
        3'd2: data_to_write_q = 32'hAAAAAAAA;
        3'd3: data_to_write_q = 32'h55555555;
        3'd4: data_to_write_q = 32'hFFFF0000;
        3'd5: data_to_write_q = 32'h0000FFFF;
        3'd6: data_to_write_q = 32'hFFFFFFFF;
        3'd7: data_to_write_q = 32'h00000000;
        default: data_to_write_q = 32'hCAFEBABE;
    endcase
end
