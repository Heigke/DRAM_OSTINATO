...
module ddr3_decay_sweep_top (
    ...
    // Lookup table for decay times (pre-calculated exponential sweep from 1ms to 1000ms)
    // These values represent cycles at 200MHz for each decay time
    function [31:0] get_decay_time_cycles;
        input [7:0] idx;
        begin
            case (idx)
                8'd0:  get_decay_time_cycles = 32'd200_000;      // 1.0 ms
                8'd1:  get_decay_time_cycles = 32'd280_000;      // 1.4 ms
                8'd2:  get_decay_time_cycles = 32'd400_000;      // 2.0 ms
                8'd3:  get_decay_time_cycles = 32'd560_000;      // 2.8 ms
                8'd4:  get_decay_time_cycles = 32'd800_000;      // 4.0 ms
                8'd5:  get_decay_time_cycles = 32'd1_120_000;    // 5.6 ms
                8'd6:  get_decay_time_cycles = 32'd1_600_000;    // 8.0 ms
                8'd7:  get_decay_time_cycles = 32'd2_240_000;    // 11.2 ms
                8'd8:  get_decay_time_cycles = 32'd3_200_000;    // 16.0 ms
                8'd9:  get_decay_time_cycles = 32'd4_480_000;    // 22.4 ms
                8'd10: get_decay_time_cycles = 32'd6_400_000;    // 32.0 ms
                8'd11: get_decay_time_cycles = 32'd8_960_000;    // 44.8 ms
                8'd12: get_decay_time_cycles = 32'd12_800_000;   // 64.0 ms
                8'd13: get_decay_time_cycles = 32'd17_920_000;   // 89.6 ms
                8'd14: get_decay_time_cycles = 32'd25_600_000;   // 128.0 ms
                8'd15: get_decay_time_cycles = 32'd35_840_000;   // 179.2 ms
                8'd16: get_decay_time_cycles = 32'd51_200_000;   // 256.0 ms
                8'd17: get_decay_time_cycles = 32'd71_680_000;   // 358.4 ms
                8'd18: get_decay_time_cycles = 32'd102_400_000;  // 512.0 ms
                8'd19: get_decay_time_cycles = 32'd200_000_000;  // 1000.0 ms
                default: get_decay_time_cycles = 32'd200_000;    // 1.0 ms default
            endcase
        end
    endfunction
